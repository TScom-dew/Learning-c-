...
*/
// this code represents how to store complex number using structure in c language ...
...
int main(){
  ...
  struct complexnumber n1={51,27};
  struct complexnumber *ptr1=&n1;
  printf("Real part:%d\n",ptr1->real);
  printf("Imaginary part:%d\n",ptr1->imaginary);
  printf("value of number two\n");
  struct complexnumber n2={44,62};
  struct complexnumber *ptr2=&n2;
  printf("Real part:%d\n",ptr2->real);
  printf("Imaginary part:%d\n",ptr2->imaginary);
